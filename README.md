...
dependencies {
  ...
  api "com.github.tommyettinger:anim8-gdx:0.3.4"
}
```
...
`implementation "com.github.tommyettinger:anim8-gdx:0.3.4:sources"`. The PNG-related code isn't available on GWT because

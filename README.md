...
dependencies {
  ...
  api "com.github.tommyettinger:anim8-gdx:0.2.5"
}
```
...
`implementation "com.github.tommyettinger:anim8-gdx:0.2.5:sources"`. The PNG-related code isn't available on GWT because

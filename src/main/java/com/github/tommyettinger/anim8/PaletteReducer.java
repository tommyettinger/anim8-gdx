...
public class PaletteReducer {
     ...
     * as its first item, but has no other transparent or partially transparent colors. Some colors in this may be
     * considered duplicates when {@link #shrink(int)} has been called on them. This is meant to be used by

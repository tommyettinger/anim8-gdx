...
public class PaletteReducer {
     ...
     * grid, the bytes will follow a blue noise frequency (and in this case, will have a triangular value distribution).
     ...
     * become null. This uses a triangular value distribution because it seems to significantly improve the perceptual
     * smoothness of dithered gradients, relative to a uniform value distribution.
     */

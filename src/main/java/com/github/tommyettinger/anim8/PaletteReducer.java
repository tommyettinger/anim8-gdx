...
public class PaletteReducer {
     ...
     * to make pixel art look good enough with dithering, and it continues to improve with more colors.
     */
    private static final int[] HALTONIC = new int[]{
